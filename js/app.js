...
if (iconMenu != null) {
	...
	let menuBlok = document.querySelector(".header__menu-list");
	iconMenu.addEventListener("click", function (e) {
		if (unlock) {
		
			iconMenu.classList.toggle("_active");
			menuBody.classList.toggle("_active");
			menuBlok.classList.toggle("_active");
		}
	});
...
let moreMenu = document.querySelector(".training__more");
if (moreMenu != null) {
	
	let moreInner = document.querySelector(".training__inner");
	moreMenu.addEventListener("click", function (e) {
		if (unlock) {
			moreInner.classList.toggle("training__inner-more");
...
let moreMenuBot = document.querySelector(".training__bottom-btn");
if (moreMenuBot != null) {
	
	let moreInner = document.querySelector(".training__inner");
	moreMenuBot.addEventListener("click", function (e) {
		if (unlock) {
			moreInner.classList.toggle("training__inner-more");
